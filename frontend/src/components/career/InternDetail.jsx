...
function InternDetail() {
  ...
  return (
    <div className='jd_main'>
      ...
      <div>
        <h1 className='application_title'>{jobData.internshipName} Application</h1>
      </div>
        ...
        <div className='jd_div1'>
          ...
          <div className='jd_div11'>
            ...
            >
              ...
              <TextField required id="outlined-required" label="Year Passing" variant="outlined" className={`errormsg ${errors.yearPassing ? 'error' : ''}`}   {...register('yearPassing', { required: 'yearPassing is required' })} />
              <TextField required id="outlined-required" label="College Name" variant="outlined" className={`errormsg ${errors.college ? 'error' : ''}`}   {...register('college', { required: 'college is required' })} />
              <TextField required id="outlined-required" label="cgp" variant="outlined" className={`errormsg ${errors.cgp ? 'error' : ''}`}   {...register('cgp', { required: 'cgp is required' })} />
