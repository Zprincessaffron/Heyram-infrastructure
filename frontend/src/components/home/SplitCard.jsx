  ...
  return (
    <div className='sc_main'>
        ...
        <div className='sc_div2'>
            ...
            <div className={`sc_div2_1 ${hoverState == "two"?"true":""}`} onMouseEnter={()=>handleMouseIn("two")}  onMouseLeave={()=>setHoverState("")} >

            </div>
            <div className={`sc_div2_1 ${hoverState == "three"?"true":""}`} onMouseEnter={()=>handleMouseIn("three")}  onMouseLeave={()=>setHoverState("")} >

            </div>
            <div className={`sc_div2_1 ${hoverState == "four"?"true":""}`} onMouseEnter={()=>handleMouseIn("four")}  onMouseLeave={()=>setHoverState("")} >
