    ...
    return (
        <div className='si_main'>
            ...
            <div className='si_div1'>
                        ...
                        <div onClick={handleScrollToBottom} style={{ width: "300px", marginLeft: "200px" }}>
                            <div className='msl_main'>
                                ...
                                <div className='msl_div1'>
                                    <div>
                                        <div className={`msl_servicename ${currentText == "planning & discovery"?"true":''}`} onClick={() => handleSubServiceClick("planning & discovery")} >PLANNING AND DISCOVERY</div> <div className='ms_border'></div>
                                    </div>
                                    <div><div className={`msl_servicename ${currentText == "design"?"true":''}`} onClick={() => handleSubServiceClick("design")} >DESIGN</div><div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "development"?"true":''}`}  onClick={() => handleSubServiceClick("development")} >DEVELOPMENT</div> <div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "testing & launch"?"true":''}`} onClick={() => handleSubServiceClick("testing & launch")} >TESTING & LAUNCH</div> <div className='ms_border'></div> </div>

                                </div>
                                <div className='msl_div2'>
                                </div>
                            </div>
                    ...
                    {contentAnim == 'digital' && (
                        ...
                        <div onClick={handleScrollToBottom} style={{ width: "300px", marginLeft: "200px" }}>
                            <div className='msl_main'>
                                <div className='msl_div1'>
                                    <div>
                                        <div className={`msl_servicename ${currentText == "planning & discovery"?"true":''}`} onClick={() => handleSubServiceClick("planning & discovery")} >RESEARCH & STRATEGY</div> <div className='ms_border'></div>
                                    </div>
                                    <div><div className={`msl_servicename ${currentText == "design"?"true":''}`} onClick={() => handleSubServiceClick("design")} >PLANNING</div><div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "development"?"true":''}`} onClick={() => handleSubServiceClick("development")} >EXECUTION & CAMPAIGN</div> <div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "testing & launch"?"true":''}`} onClick={() => handleSubServiceClick("testing & launch")} >ANALYSIS & OPTIMIZATION</div> <div className='ms_border'></div> </div>
                                </div>
                                <div className='msl_div2'>
                                </div>
                            </div>
                    ...
                    {contentAnim == 'data' && (
                        ...
                        <div onClick={handleScrollToBottom} style={{ width: "300px", marginLeft: "200px" }}>
                            <div className='msl_main'>
                                <div className='msl_div1'>
                                    <div>
                                        <div className={`msl_servicename ${currentText == "planning & discovery"?"true":''}`} onClick={() => handleSubServiceClick("planning & discovery")} >PROBLEM DEFINITION</div> <div className='ms_border'></div>
                                    </div>
                                    <div><div className={`msl_servicename ${currentText == "design"?"true":''}`} onClick={() => handleSubServiceClick("design")} >DATA COLLECTION</div><div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "development"?"true":''}`} onClick={() => handleSubServiceClick("development")} >DEVELOPMENT</div> <div className='ms_border'></div> </div>
                                    <div><div className={`msl_servicename ${currentText == "testing & launch"?"true":''}`} onClick={() => handleSubServiceClick("testing & launch")} >DEPLOYMENT</div> <div className='ms_border'></div> </div>
                                </div>
                                <div className='msl_div2' >
                                </div>
                            </div>
                ...
                <div className='si_rightkey' onClick={handleArrowClick} style={{width:"20px"}}>
