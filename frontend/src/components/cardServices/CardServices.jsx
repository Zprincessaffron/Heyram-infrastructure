...
function CardServices() {
  ...
  return (
    ...
    <div className="cs_main">
      <div
        className="cs_container1"
        style={{ backgroundImage: `url(${background})` }}
      >
        <div>
          <h1>START-UP COMPANIES</h1>
          <p>
            Start-ups need a strong foundation to establish their presence and
            compete effectively in the digital marketplace. We offer a
            comprehensive range of services to help new businesses build,
            promote, and grow their brands
          </p>
        </div>
      </div>
        ...
        <div className="cs_container2_splitter">
          <div className="cs_container2_1">
            ...
            <p>
              ...
              {data.webDevelopment[0].content}
            </p>
          </div>
          <div
            className="cs_container2_2"
            style={{ backgroundImage: `${dottedback}` }}
          >
            <Lottie
              style={{ opacity: "80%" }}
            ...
            {data.digitalMarketing.map((item) => (
              <div className="cs_container411">
                ...
                <div className="cs_container411_2">
                  <div
                    className={`cs_container411_21 ${
                      heigth == item.title ? "true" : ""
                    }`}
                  >
                    <h1>{item.title}</h1>
                    <p>{item.content}</p>
                  ...
                  <div className="cs_container411_22">
                    <div
                      className={`cs_container411_22_2 ${
                        heigth == item.title ? "true" : ""
                      }`}
                    >
                      <FaArrowAltCircleDown
                        onClick={() => handleHeight(item.title)}
                      />
                    </div>
                  </div>
                </div>
