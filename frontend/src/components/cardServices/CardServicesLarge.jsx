...
import datanalysis from '../../images/dataanalysis.jpg'
    ...
    return (
        <div className='cs_main'>
            <div className='cs_container1' style={{backgroundImage:`url(${background})`}}>
                <div>
                    <h1>GLOBAL ORGANIZATIONS</h1>
                    <p>Global Organizations require robust solutions for diverse markets. We deliver strategies that enhance brand visibility and performance on a global scale.</p>
            ...
            <div className=' pl-[3rem] pb-[3rem] w-[100%] '>
                ...
                <div className='cs_container6'  >
                    <div className='cs_container61'>
                        <img src={datanalysis} alt="" />

                    </div>
                    <div className='cs_container62' >
                        <h1>{data.dataanalysis[0].title}</h1>
                        <p>{data.dataanalysis[0].content}</p>
...
export default CardServicesLarge